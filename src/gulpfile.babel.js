...
gulp.task('fileInclude', () => gulp.src(PATH.src.html, { since: gulp.lastRun('fileInclude') })
  .pipe(plumber({
...
gulp.task('scripts', () => gulp.src(PATH.src.js, { since: gulp.lastRun('scripts') })
  .pipe(plumber({
    errorHandler: notify.onError(err => ({
      title: 'scripts',
      message: err.message
...
gulp.task('imageMin', () => gulp.src(PATH.src.img, { since: gulp.lastRun('imageMin') })
  .pipe(plumber({
    errorHandler: notify.onError(err => ({
      title: 'img',
      message: err.message
